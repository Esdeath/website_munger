...
- [ ] **Step 1: 为 frontmatter 和 loader 写失败测试**
...
Run: `git status --short && git diff --check HEAD~7..HEAD`
...
test "$(rg -o '思维模型讲义[0-9]{2}：' dist/topics/mental-model-lectures/index.html | wc -l | tr -d ' ')" = "12"
...
```bash
rg -q '思维模型讲义01-多元思维模型与跨学科智慧' dist/articles/跨学科普世智慧-把各学科的大思想综合起来/index.html
rg -q '思维模型讲义06-误判心理学激励社会认同与条件反射' dist/articles/思维模型讲义08-激励机制告诉我激励我告诉你结果/index.html
rg -q '思维模型讲义10-逆向思维与检查清单' dist/articles/检查清单-像飞行员一样起飞前逐项核对/index.html
rg -q '思维模型讲义11-客观理性与常识' dist/articles/常识-并不常见的判断力/index.html
```
